        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    poly_geometry = table.Column<Polygon>(type: "geometry", nullable: true),
                    mpoly_geometry = table.Column<MultiPolygon>(type: "geometry", nullable: true),
                    point_eometry = table.Column<Point>(type: "geometry", nullable: true),
                    line_geometry = table.Column<LineString>(type: "geometry", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "cdfw_spotted_owls_hex160s",
                schema: "public",
                columns: table => new
                {
                    cdfw_spotted_owl_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cdfw_spotted_owls_hex160s", x => new { x.cdfw_spotted_owl_id, x.hex160_id });
                    table.ForeignKey(
                        name: "FK_cdfw_spotted_owls_hex160s_cdfw_spotted_owls_cdfw_spotted_ow~",
                        column: x => x.cdfw_spotted_owl_id,
                        principalTable: "cdfw_spotted_owls",
                        principalColumn: "guid",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_cdfw_spotted_owls_hex160s_hex160s_hex160_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cdfw_spotted_owls_hex160s_hex160_id",
                schema: "public",
                table: "cdfw_spotted_owls_hex160s",
                column: "hex160_id");
