...
namespace WBIS_2.DataModel.Migrations
{
    ...
    [Migration("20220526142004_SiteCallingKeysUpdate")]
    partial class SiteCallingKeysUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hex160_required_passes_districts", b =>
                {
                    b.Property<Guid>("district_id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("hex160_required_pass_id")
                        .HasColumnType("uuid");

                    b.HasKey("district_id", "hex160_required_pass_id");

                    b.HasIndex("hex160_required_pass_id");

                    b.ToTable("hex160_required_passes_districts", "public");
                });
            ...
            modelBuilder.Entity("hex160_required_passes_districts", b =>
                {
                    ...
                    b.HasOne("WBIS_2.DataModel.Hex160RequiredPass", null)
                        .WithMany()
                        .HasForeignKey("hex160_required_pass_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
