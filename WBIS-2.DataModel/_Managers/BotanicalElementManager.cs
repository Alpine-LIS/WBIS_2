...
{
    public class BotanicalElementManager : IInfoTypeManager, IRecordOptions
    {
        ...
        {
            IQueryable<BotanicalElement> returnVal = model.Set<BotanicalElement>()
                .AsNoTracking()
            ...
            if (QueryType == typeof(District))
                ...
                returnVal = returnVal.Include(_ => _.BotanicalSurvey).Where(a);
